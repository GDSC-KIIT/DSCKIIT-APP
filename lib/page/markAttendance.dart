        ...
        builder: (context, snapshot) {
          ...
          return ListView(
            children: snapshot.data.documents
              ...
              return documentSnapshot.data['uid'] == null
                  ? SizedBox()
                  : Padding(
                      padding:
                      ...
                      child: AttendeeCard(
                        ...
                        value:
                            _attendees.indexOf(documentSnapshot.data['uid']) ==
                                    -1
                                ? false
                                : true,
                      ),
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () async {
          ...
          Firestore.instance
              .collection('meetings')
              .document(widget.uid)
              .updateData({"attendees": _attendees, "absentees": _absentees});
          Toast.show(
            "Marked",
            context,
            ...
            children: <Widget>[
              ClipOval(
                child: FadeInImage.assetNetwork(
                  ...
                  image: widget.ds.data['photoURL'].toString().isNotEmpty
                      ? widget.ds.data['photoURL']
